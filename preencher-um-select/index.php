				...
				<tbody>
					...
					while ($result_query_tarefas = mysqli_fetch_assoc($query_tarefas)) {
						$id_tarefas = $result_query_tarefas['id_tarefas'];
							...
							echo "<td>
									<a class='btn btn-success' href='processo-finaliza-tarefa.php?id_tarefas=$id_tarefas'>Confirmar <i class='fa-solid fa-circle-check fa-xs'></i></a>
									&emsp;&emsp;<a class='btn btn-danger' href='finaliza-tarefa.php?id_tarefas=$id_tarefas'>Não confirmar <i class='fa-solid fa-circle-xmark fa-xs'></i></a>
								</td>";
						echo "</tr>";
					}
					?>
					...
					<br>
			      	<div class="row">
			      			<div class="col-md">
			      				...
			      				<textarea class="form-control form-control-sm" rows="5" placeholder="Digite aqui..." required="" name="tarefa"></textarea>
			      			</div>
			      	</div>
			      </div>
